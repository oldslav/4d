<template lang="pug">
	.data-environment.fit
		...
		q-tabs.q-mx-md(
			...
			q-tab(name="pedestrian" :label="$t('entity.data.transport.chart.pedestrian')")
			q-tab(name="bicycle" :label="$t('entity.data.transport.chart.bicycle')")
			q-tab(name="car" :label="$t('entity.data.transport.chart.car')")
			q-tab(name="parking" :label="$t('entity.data.transport.chart.parking')")

		q-tab-panels.q-pa-none.bg-transparent(v-model="tab")
			q-tab-panel.q-pa-none(name="pedestrian")
				Pedestrian(:data="getTransport")
			q-tab-panel.q-pa-none(name="bicycle")
				Bicycle(:data="getTransport")
			q-tab-panel.q-pa-none(name="car")
				Car(:data="getTransport")
			q-tab-panel.q-pa-none(name="parking")
				Parking(:data="getTransport")
...
<script>
	...
	import Pedestrian from "@/components/data/transport/Pedestrian.vue";
	import Bicycle from "@/components/data/transport/Bicycle.vue";
	import Car from "@/components/data/transport/Car.vue";
	import Parking from "@/components/data/transport/Parking.vue";
