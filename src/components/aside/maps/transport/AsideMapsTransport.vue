<template lang="pug">
  aside-router-view(name="asideTransport")
    div
      q-list
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters("maps/transport", ["getMenu", "getGeoJSON"]),
      layersBySection (){
    ...
    methods: {
      ...mapActions("maps/transport", {
        fetchSectionGeoJSON: FETCH_TRANSPORT_SECTION_GEOJSON,
        toggleVisibilityByLayer: TOGGLE_TRANSPORT_VISIBILITY_BY_LAYER
      }),
