<template lang="pug">
  q-form(@submit="onSubmit()")
    ...
    .text-subtitle.q-my-sm {{ $t("entity.documents.title") }}
      file-picker(:label="this.$t('entity.files.birth')" @remove="onRemove" v-model="neighbor.documents.birth" :readonly="readonly")
      file-picker(:label="this.$t('entity.files.children_registration')" @remove="onRemove" v-model="neighbor.documents.children_registration" :readonly="readonly")
