<template lang="pug">
  q-form(@submit="onSubmit()")
    ...
    .text-subtitle.q-my-sm {{ $t("entity.documents.title") }}
      file-picker(:label="this.$t('entity.files.birth')" @remove="onRemove" v-model="neighbor.documents.birth" :readonly="readonly" :rules="documentRequired")
      file-picker(:label="this.$t('entity.files.children_registration')" @remove="onRemove" v-model="neighbor.documents.children_registration" :readonly="readonly" :rules="documentRequired")
      file-picker(:label="this.$t('entity.files.passport')" @remove="onRemove" :max-files="5" v-model="neighbor.documents.passport" :readonly="readonly" :rules="documentRequired")
