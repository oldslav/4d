      ...
      q-step(
        ...
        .row
          ...
          .col-6.text-body1.text-wrap
            | Для осмотра квартиры вы можете связаться с сотрудниками “Фонда развития города Иннополис”<br><br>По телефону +7 (937) 588-01-40 или в телеграмме @InnoRentHome.<br><br>Осмотр квартиры является необязательным, вы можете сразу перейти к оплате.<br><br>Фонд развития города Иннополис
            div.text-right.q-mt-lg
            ...
            div.q-col-gutter-sm.q-mt-md
              ...
              .flex.items-center.justify-between
                ...
                div
                  | 9:00 - 17:00
              div
                | Если вы хотите отменить заявку, свяжитесь с сотрудниками “Фонда развития города Иннополис” по телефону +7 (937) 588-01-40 или в телеграмме @InnoRentHome<br>
                | Фонд развития города Иннополис
</template>
