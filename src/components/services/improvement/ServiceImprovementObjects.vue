...
<script>
  ...
  export default {
    name: "ServiceImprovementObjects",
    ...
    computed: {
      ...mapState("services/improvement/art", {
        filters: state => state.filters
      }),

      ...mapGetters("services/improvement/art", [
        "tablePagination",
        "tableData",
        "categories"
      ]),

      ...mapFields("services/improvement/art", {
      ...
      isLoading () {
        return this.$store.state.wait[`services/improvement/art/${ GET_DATA }`];
      }
    },
    methods: {
      moment,
      ...
      ...mapActions("services/improvement/art", {
        GET_DATA,
        GET_REFERENCES
      }),
      ...
      toDetails (id) {
        this.$router.push({
          name: "gis-services-improvement-art-details",
          params: {
            id
          }
        });
