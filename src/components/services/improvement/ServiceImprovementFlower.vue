...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState("services/improvement/flower", {
        filters: state => state.filters
      }),

      ...mapGetters("services/improvement/flower", [
        "tablePagination",
        "tableData",
        "categories"
      ]),

      ...mapFields("services/improvement/flower", {
      ...
      isLoading () {
        return this.$store.state.wait[`services/improvement/flower/${ GET_DATA }`];
      }
    },
    methods: {
      moment,
      ...
      ...mapActions("services/improvement/flower", {
        GET_DATA,
        GET_REFERENCES
      }),
      ...
      toDetails (id) {
        this.$router.push({
          name: "gis-services-improvement-flower-details",
          params: {
            id
          }
        });
