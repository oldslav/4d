...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState("services/planning/border", {
        filters: state => state.filters
      }),

      ...mapGetters("services/planning/border", [
        "tablePagination",
        "tableData",
        "categories"
      ]),

      ...mapFields("services/planning/border", {
      ...
      isLoading () {
        return this.$store.state.wait[`services/planning/border/${ GET_DATA }`];
      }
    },
    methods: {
      moment,
      ...
      ...mapActions("services/planning/border", {
        GET_DATA,
        GET_REFERENCES
      }),
      ...
      toDetails (id) {
        this.$router.push({
          name: "gis-services-planning-border-details",
          params: {
            id
          }
        });
